<?php
// This form allows the authorised user to edit staff details
...
include_once ("class/EditStaffClass.php");
...
<html>
	...
	<script>
		  /* function disable_input() is used to disable input fields when user clicks Cancel button */
    ...
    <body>
            ...
            <!-- Header -->
			 <!-- Start Top Bar -->
				<div class="top-bar">
					<div>
						<ul class="menu">
							<li class="menu-text" style="padding-left:10px"><b>Edit Staff</b></li>
						</ul>
					</div>
					<div>
						<ul class="menu">
        ...
        <div class="w3-container w3-center" id="ctneditstaff" style="margin-top:10px">
		    <form id="formeditstaff" method = "post">
				<?php
					//Find the staff that matches the specified id
				...
				?>
						<div class="form-section required">
							...
							<input class="form-input input-border col-25" id="staff_name" name="staff_name" type="text" class="form-control" required value = "<?php echo $staff['name'];?>" pattern="[a-zA-Z- ]+" title="Name can contain alphabets, spaces( ) and hyphen(-) only!" tabindex="1">
						</div>
						
						<div class="form-section required">
							<label class="control-label col-label" for="username">Username</label>
							<input class="form-input input-border col-25" id="username" name="username" type="text" class="form-control" required pattern="[a-zA-Z0-9]+" title="Username can contain alphabets and numbers only!" value = "<?php echo $staff['username'];?>" tabindex="2">
						</div>
						
						<div class="form-section required">
							<label class="control-label col-label" for="password">New Password</label>
				...
				?>
					...
					<div class="form-section">
                        <button type="submit" class="button-1 padding-1 center-block w3-light-blue" name="cancel" id="cancel" tabindex="14" value="cancel" onClick="disable_input()">Cancel</button>
